                    ...
                    <div className="inputGroup mt-10 relative flex flex-col space-y-2 flex-1 ">
                      ...
                      <div className="boxBodyBottom my-5 bg-[#F4F4F4] sm:px-5 px-2 py-4 shadow-lg  w-full">
                        <textarea
                          ...
                          className="w-full text-gray resize-none placeholder:text-gray placeholder:text-[1rem] border-0 outline-0 focus:outline-0 focus:border focus:ring-1 rounded-lg focus:border-green-400 sm:px-2 py-3 p-5"
                        ></textarea>
